...
# # Note: Celery configuration at end of settings.py
...
# # Building footprint Mask R-CNN model
# BUILDING_FOOTPRINT_MODEL_PATH = os.environ.get(
#     "BUILDING_FOOTPRINT_MODEL_PATH",
#     os.path.join(BASE_DIR, "ai_models", "building_maskrcnn_trained.pth"),
# )
# BUILDING_FOOTPRINT_TILE_SIZE = int(os.environ.get("BUILDING_FOOTPRINT_TILE_SIZE", "2048"))
# BUILDING_FOOTPRINT_CONFIDENCE = float(os.environ.get("BUILDING_FOOTPRINT_CONFIDENCE", "0.30"))

# # Celery Configuration - Using in-memory broker for development
# # For production with Redis: set CELERY_BROKER_URL environment variable
